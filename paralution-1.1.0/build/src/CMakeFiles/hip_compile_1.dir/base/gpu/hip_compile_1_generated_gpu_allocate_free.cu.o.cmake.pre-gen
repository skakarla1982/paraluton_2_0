...
set(HIP_HIPCC_EXECUTABLE "/opt/rocm-3.3.0/hip/bin/hipcc") # path
set(HIP_HIPCONFIG_EXECUTABLE "/opt/rocm-3.3.0/hip/bin/hipconfig") #path
set(HIP_HOST_COMPILER "") # path
set(CMAKE_COMMAND "/usr/bin/cmake") # path
set(HIP_run_make2cmake "/opt/rocm/hip/cmake/FindHIP/run_make2cmake.cmake") # path
set(HCC_HOME "") #path
...
set(HIP_HIPCC_INCLUDE_ARGS "") # list (needs to be in quotes to handle spaces properly)

set(cmake_dependency_file "/paralution/para-2.0/paralution-1.1.0/build/src/CMakeFiles/hip_compile_1.dir/base/gpu/hip_compile_1_generated_gpu_allocate_free.cu.o.depend") # path
set(source_file "/paralution/para-2.0/paralution-1.1.0/src/base/gpu/gpu_allocate_free.cu") # path
set(host_flag "") # bool
